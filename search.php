...
<div class="container py-3">
    <header>
        ...
        <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
         <div class="container py-3">
         <h1 class="display-4 fw-normal text-body-emphasis">hakutuloksesi</h1>
         <p>napsauta palataksesi kirjaluetteloihin</p>
         <a href="availablebook.php" class="btn btn-primary">Palaa kirjalisraus</a>
